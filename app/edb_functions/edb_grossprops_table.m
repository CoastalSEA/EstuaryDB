...
function gp = addMouthProps(var,gp,z,wl)
    ...
    A0 = var.A(1,:);
    gp.Whw = interp1(z,W0,wl.HW);
    gp.Wmt = interp1(z,W0,wl.MT);
    gp.Wlw = interp1(z,W0,wl.LW);

    gp.Ahw = interp1(z,A0,wl.HW);
    gp.Amt = interp1(z,A0,wl.MT);
    gp.Alw = interp1(z,A0,wl.LW);
...
function dsp = setDSproperties()
    ...
    %struct entries are cell arrays and can be column or row vectors
        vars = {'Dateset','Source dataset','-','Source dataset','derived';...%NB this duplicates class property Source. Can only access using DataTable
                ...
                'Whw','HW Width at mouth','m','Width (m)','derived';...
                'Wmt','MT Width at mouth','m','Width (m)','derived';...
                'Wlw','LW Width at mouth','m','Width (m)','derived';...
                'Ahw','HW CSA at mouth','m2','CSA (m^2)','derived';...
                'Amt','MT CSA at mouth','m2','CSA (m^2)','derived';...
                'Alw','LW CSA at mouth','m2','CSA (m^2)','derived';...
