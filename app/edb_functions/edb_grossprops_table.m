...
function dsp = setDSproperties()
    ...
    %struct entries are cell arrays and can be column or row vectors
        vars = {'Source','Source','-','Source','model';...
                'HWL','High water level','mAD','Tidal level (m)','model';...
                'MTL','Mean tide level','mAD','Tidal level (m)','model';...
                'LWL','Low water level','mAD','Tidal level (m)','model';...
                'Shw','HW Surface Area','m2','Surface area (m^2)','model';...
                'Smt','MT Surface Area','m2','Surface area (m^2)','model';...
                'Slw','LW Surface Area','m2','Surface area (m^2)','model';...
                'Vhw','HW Volume','m3','Volume (m^3)','model';...
                'Vmt','MT Volume','m3','Volume (m^3)','model';...
                'Vlw','LW Volume','m3','Volume (m^3)','model';...
                'Pr','Tidal Prism','m3','Volume (m^3)','model';...
                'Gamma','Gamma','-','Gamma','model';...
                'Vs','Storage Volume','m3','Volume (m^3)','model';...
                'Vc','Channel Volume','m3','Volume (m^3)','model';...
                'VsoVc','Storage to Channel Volume ratio','-','Storage to Channel Volume ratio (-)','model';...
                'SflShw','Intertidal to Basin Area ratio','-','Intertidal to Basin Area ratio (-)','model';...
                'amp','Tidal amplitude at mouth','m','Tidal amplitude (m)','model';...
                'hyd','MT Hydraulic depth','m','Hydraulic depth (m)','model';...
                'aoh','Amplitude to Depth ratio','-','Amplitude to Depth ratio (-)','model';...
                'Wmt','MT Width at mouth','m','Width (m)','model';...
                'Amt','MT CSA at mouth','m2','CSA (m^2)','model';...
                'PoA','MT Prism over CSA','m','Prism to Area ratio','model';...
                'Notes','Notes','-','Notes','model'};
